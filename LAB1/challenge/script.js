...
let siblingamt = 129 / 3;
console.log(siblingamt);
// 2. How many games can Jordan buy with their cut?
let possibleGames = siblingamt / game;
...
let quinnandcardo = siblingamt + siblingamt;
let qncAfter4Weeks = quinnandcardo * 4;
let possibleshoes = qncAfter4Weeks / shoes;
console.log(possibleshoes);
// 5. How many more games can they buy if they put their money together compared to if they had bought games on their own?
let amountBySelf = siblingamt / game;
let amountTogether = quinnandcardo / game;
console.log(amountTogether - amountBySelf);
...
let sib = sibling3.replace("Ricardo Montoya", "")
console.log(sib.replace("Ramirez", ""));
// Medium Challenges



// write these function as an arrow function.
...
console.log(greeting("JohnMiasma"));
...
const shortenString = (string) => {
    if (string.length > 10) {
        return string.substring(0, 0); // Return the first 10 characters
    } else {
        return string.substring(0, 10); // Return the string as is if it's 10 characters or shorter
    }
}

console.log(shortenString("Supercalifr"))
